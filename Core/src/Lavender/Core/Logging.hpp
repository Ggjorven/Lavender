...
namespace Lavender
{
	...
	public:
		...
		#ifndef APP_DIST
		#define APP_LOG_TRACE(...)	Lavender::Log::LogMessage(Lavender::Log::Level::Trace, __VA_ARGS__);
		#define APP_LOG_INFO(...)	Lavender::Log::LogMessage(Lavender::Log::Level::Info, __VA_ARGS__);
		#define APP_LOG_WARN(...)	Lavender::Log::LogMessage(Lavender::Log::Level::Warn, __VA_ARGS__);
		#define APP_LOG_ERROR(...)	Lavender::Log::LogMessage(Lavender::Log::Level::Error, __VA_ARGS__);
		#define APP_LOG_FATAL(...)	Lavender::Log::LogMessage(Lavender::Log::Level::Fatal, __VA_ARGS__);
		#else
